...
function [p_uncorrected,p_corrected] = nets_glm_grp(netmats,des,con,grp,view,varargin)
...
%problem wtih this lin??? 



system(sprintf('randomise -i %s -o %s -d %s -t %s -e %s -x --uncorrp -n %d',fname,fname,des,con,grp,nperms));
